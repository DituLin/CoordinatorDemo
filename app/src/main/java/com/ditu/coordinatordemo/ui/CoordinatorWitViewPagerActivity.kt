...
import com.ditu.coordinatordemo.databinding.ActivityCoordinatorWitViewPagerBinding
...
class CoordinatorWitViewPagerActivity : AppCompatActivity() {

    private val titles = arrayOf("推荐","热门")

    private val listFragment = mutableListOf<Fragment>()

    private lateinit var binding: ActivityCoordinatorWitViewPagerBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCoordinatorWitViewPagerBinding.inflate(layoutInflater)
    ...
    private fun initUI() {
        ...
        binding.vpCoordinator.adapter = adapter
        binding.vpCoordinator.offscreenPageLimit = titles.size
        binding.stlCoordinator.setViewPager(binding.vpCoordinator,titles)
        binding.stlCoordinator.setOnTabSelectListener(object : OnTabSelectListener {
        ...
        binding.vpCoordinator.addOnPageChangeListener(object : ViewPager.OnPageChangeListener{
